...
module.exports = {
	...
	easeInOutQuad: require('./easeInOutQuad')
};

},{"./easeInOutQuad":4,"./linear":6}],6:[function(require,module,exports){
'use strict';
...
},{"./easing":5,"./lib/scrolltop":8,"./lib/vendorprefix":9,"mout/function/debounce":10,"mout/lang/isArray":11,"mout/lang/isString":13}],8:[function(require,module,exports){
'use strict';
...
},{"./device":18,"./web":21,"jquery":3}],16:[function(require,module,exports){
var Backdrop, imagesLoaded;

imagesLoaded = require('imagesloaded');

module.exports = Backdrop = (function() {
  function Backdrop(arg) {
    this.$el = arg.$el, this.$window = arg.$window, this.$body = arg.$body;
  ...
  Backdrop.prototype.scale = function() {
    var dimensions, height, ref, width;
    ref = dimensions = this.dimensions(), width = ref.width, height = ref.height;
    return setTimeout((function(_this) {
      return function() {
        return _this.$el.addClass('is-ready').css({
          transform: "scale(" + (_this.factor(dimensions)) + ")",
          marginTop: -(height / 2),
          marginLeft: -(width / 2)
        });
      };
  ...
  Backdrop.prototype.dimensions = function() {
    var $clone, dimensions;
  ...
  Backdrop.prototype.factor = function(dimensions) {
    var direction, factor, height, ratio, viewportRatio, width;
    width = dimensions.width, height = dimensions.height;
    ratio = width / height;
    viewportRatio = this.$window.width() / this.$window.height();
    direction = viewportRatio > ratio ? 'width' : 'height';
    factor = this.$window[direction]() / dimensions[direction];
...
},{"imagesloaded":2}],17:[function(require,module,exports){
...
module.exports = Backdrops = (function() {
  function Backdrops(arg) {
    this.$els = arg.$els;
    this.scale = bind(this.scale, this);
    this.$window = $(window);
    this.$body = $('body');
    this.backdrops = this.$els.map((function(_this) {
    ...
    this.$window.on('resize', this.scale);
  }

  Backdrops.prototype.scale = function() {
    var backdrop, j, len, ref, results;
    ref = this.backdrops;
    results = [];
    for (j = 0, len = ref.length; j < len; j++) {
      backdrop = ref[j];
      results.push(backdrop.scale());
    }
    return results;
  };
...
},{"./backdrop":16,"jquery":3}],18:[function(require,module,exports){
module.exports = {
  isTouch: function() {
...
var $, Preloader, imagesLoaded;

$ = require('jquery');

imagesLoaded = require('imagesloaded');

module.exports = Preloader = (function() {
  function Preloader(arg) {
    this.application = arg.application;
    this.$el = $('#preloader');
    (this.$body = $('body')).attr('data-application', this.application);
  ...
  Preloader.prototype.setImages = function() {
  ...
  Preloader.prototype.until = function(selector, cb) {
    return imagesLoaded(selector, (function(_this) {
      return function() {
        _this.done();
  ...
  Preloader.prototype.done = function() {
    ...
    this.$body.attr('data-state', 'done');
    return setTimeout(((function(_this) {
      return function() {
...
},{"imagesloaded":2,"jquery":3}],20:[function(require,module,exports){
var $, Share,
  bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; };
...
module.exports = Share = (function() {
  ...
  function Share(arg) {
    ...
    this.$twitter.on('click', (function(_this) {
      return function(e) {
        e.preventDefault();
        return _this.popUp(_this.twitter);
      };
    })(this));
    this.$facebook.on('click', (function(_this) {
      return function(e) {
        e.preventDefault();
        return _this.popUp(_this.facebook);
      };
    })(this));
    this.getCounts();
  }

  Share.prototype.popUp = function(callback) {
    var $window, height, options, wLeft, wTop, width;
    width = 750;
    height = 400;
    $window = $(window);
    wLeft = (typeof window !== "undefined" && window !== null ? window.screenLeft : void 0) || window.screenX;
    wTop = (typeof window !== "undefined" && window !== null ? window.screenTop : void 0) || window.screenY;
    options = {
      width: width,
      height: height,
    ...
    return callback("status=1,width=" + options.width + ",height=" + options.height + ",top=" + options.top + ",left=" + options.left);
  };

  Share.prototype.facebook = function(opts) {
    var url;
    url = "https://www.facebook.com/sharer/sharer.php?u=" + this.href;
    return window.open(url, 'facebook', opts);
  };

  Share.prototype.twitter = function(opts) {
    var url;
    url = "https://twitter.com/intent/tweet?original_referer=" + this.href + "&text=" + this.text + ":&url=" + this.href + "&via=artsy";
    return window.open(url, 'twitter', opts);
  };

  Share.prototype.getCounts = function() {
    $.get("http://api.facebook.com/restserver.php?method=links.getStats&urls[]=" + this.href, function(response) {
      return $('.facebook-count').text($(response).find('share_count').text() || '...');
    });
    return $.getJSON("http://urls.api.twitter.com/1/urls/count.json?url=" + this.href + "&callback=?", function(response) {
      return $('.twitter-count').text((response != null ? response.count : void 0) || '...');
    });
  };
...
var $, Backdrops, Kubrick, Preloader, Share, Web, timeline;
...
module.exports = Web = (function() {
  function Web() {
    ...
    new Preloader({
      application: 'web'
    }).until('#frame-introduction', (function(_this) {
      return function() {
        return _this.backdrops = new Backdrops({
          $els: $('.frame--backdrop img')
        });
      };
    })(this));
  }

  Web.prototype.setupTimeline = function() {
    this.timeline = Kubrick(timeline);
    return $('#frame-introduction').show();
  };

  Web.prototype.setupShare = function() {
    return new Share({
  ...
  Web.prototype.setupKeyboard = function() {
    return $(document).on('keydown', (function(_this) {
      return function(e) {
        switch (e.which) {
          case 71:
            return _this.toggleGrid();
        }
      };
    })(this));
  };

  Web.prototype.toggleGrid = function() {
    return $('.grid').toggle();
  };
...
},{"../backdrops":17,"../preloader":19,"../share":20,"./timeline":24,"jquery":3,"kubrick-js":7}],22:[function(require,module,exports){
var $, Map;
...
module.exports = Map = (function() {
  ...
  Map.prototype.period = 10;

  function Map(arg) {
    this.$paths = arg.$paths, this.split = arg.split;
    this.build();
  }

  Map.prototype.randomDelay = function() {
    return Math.floor(Math.random() * (this.period * 1000 + 1)) + 'ms';
  };

  Map.prototype.build = function() {
    var $el, j, len, length, path, ref, results;
    ...
    for (j = 0, len = ref.length; j < len; j++) {
      ...
      $el.css({
        ...
        transitionDelay: this.randomDelay()
      });
  ...
  Map.prototype.update = function(progress) {
    var fadeIn, fadeOut, i, j, k, len, len1, path, results;
    i = Math.floor(progress * (this.length - 1) / 100);
    fadeIn = this.paths.slice(0, i);
    for (j = 0, len = fadeIn.length; j < len; j++) {
      path = fadeIn[j];
      path.$el.css('stroke-dashoffset', 0);
    }
    fadeOut = this.paths.slice(i + 1, this.paths.length - 1);
    results = [];
    for (k = 0, len1 = fadeOut.length; k < len1; k++) {
      path = fadeOut[k];
      results.push(path.$el.css('stroke-dashoffset', path.length));
    }
    return results;
  };
...
opacity = require('./transitions').opacity;

module.exports = [
  {
    stage: '#frame-conclusion',
    duration: '200%',
    easing: 'linear',
    actors: [
      {
...
},{"./transitions":27}],24:[function(require,module,exports){
module.exports = [].concat(require('./introduction'), require('./main'), require('./conclusion'));


},{"./conclusion":23,"./introduction":25,"./main":26}],25:[function(require,module,exports){
var $, $header, backdropScale, opacity, ref, translateY;

$ = require('jquery');

ref = require('./transitions'), opacity = ref.opacity, translateY = ref.translateY, backdropScale = ref.backdropScale;
...
module.exports = [
  {
    stage: '#frame-introduction',
    duration: '100%',
    easing: 'linear',
    key: true,
    actors: [
      {
        element: '#introduction-backdrop-0',
        opacity: opacity.out,
        scale: backdropScale.a
      }, {
        element: '#introduction-backdrop-1',
        scale: backdropScale.a
      }, {
        element: '#introduction-credit-0',
        opacity: [0.6, 0]
      }, {
        element: '.intro-chevron',
        rotate: [45, 45],
        opacity: -1,
        translateY: -10
      }, {
        element: '.introduction--logo',
        opacity: opacity.out,
        translateY: [0, -30]
      }, {
        element: '#header-proxy',
    ...
    actors: [
      {
        ...
        element: '#introduction-headline-0',
        opacity: opacity["in"],
        translateY: translateY["in"]
      }, {
        element: '#introduction-credit-1',
        opacity: [0, 0.6]
      }
    ]
  }, {
    ...
    actors: [
      {
        element: '#introduction-backdrop-1',
        scale: backdropScale.d,
        opacity: opacity.out
      }, {
        element: '#introduction-backdrop-2',
        scale: backdropScale.a
      }, {
        element: '#introduction-headline-0',
        opacity: opacity.out,
...
},{"./transitions":27,"jquery":3}],26:[function(require,module,exports){
var $, Map, backdropScale, map, mapTransitioned, opacity, ref, transitions, translateY;

$ = require('jquery');

ref = transitions = require('./transitions'), translateY = ref.translateY, opacity = ref.opacity, backdropScale = ref.backdropScale;
...
module.exports = [
  {
    stage: '#frame-museums-and-institutions',
    duration: '100%',
    easing: 'linear',
    actors: [
      {
    ...
    stage: '#frame-educational-database',
    duration: '100%',
    easing: 'linear',
    actors: [
      {
    ...
    actors: [
      {
        ...
        element: '#graph-overlay--label_2012',
        opacity: opacity.out
      }
    ]
  }, {
    ...
    actors: [
      {
        ...
        element: '#graph-overlay--label_2013',
        opacity: opacity.out
      }
    ]
  }, {
    ...
    actors: [
      {
        ...
        element: '#graph-overlay--label_2015',
        opacity: opacity.out
      }
    ]
  }, {
    ...
    stage: '#frame-browse-and-collect-fairs',
    duration: '100%',
    easing: 'linear',
    actors: [
      {
        ...
        element: '#image-wall--image-0',
        opacity: [0, 1]
      }, {
        element: '#image-wall--image-1',
        opacity: [-0.25, 1]
      }, {
        element: '#image-wall--image-2',
        opacity: [-0.5, 1]
      }, {
        element: '#image-wall--image-3',
        opacity: [-0.75, 1]
      }
    ]
  }, {
...
},{"../map":22,"./transitions":27,"jquery":3}],27:[function(require,module,exports){
var device, generateScalingValues;

device = require('../../device');

generateScalingValues = function() {
  if (device.isFirefox()) {
    return {
      a: [1, 1],
      b: [1, 1],
...
module.exports = {
  ...
  bisectedColumnsHold: function(id) {
    return [
      {
        element: "#" + id + "--column-0",
        translateY: [5, -5]
  ...
  bisectedColumnsOut: function(id) {
    return [
      {
        element: "#" + id + "--columns",
        opacity: [1, 0]
